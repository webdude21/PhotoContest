...
var ContestantsService = (function (_MongooseRepository) {
    ...
    _createClass(ContestantsService, [{
        ...
        value: function getAllVisible() {
            return _get(Object.getPrototypeOf(ContestantsService.prototype), "wrapQueryInPromise", this).call(this, _get(Object.getPrototypeOf(ContestantsService.prototype), "model", this).find().populate("pictures"));
        }
    }, {
        key: "getAllApproved",
        value: function getAllApproved() {
            return _get(Object.getPrototypeOf(ContestantsService.prototype), "wrapQueryInPromise", this).call(this, _get(Object.getPrototypeOf(ContestantsService.prototype), "model", this).find().where("approved", true).populate("pictures"));
        }
    }, {
        key: "getQuery",
